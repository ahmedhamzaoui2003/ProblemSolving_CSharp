...
namespace ProblemSolving_CSharp.Problems_Level_2
{
    internal class Problem_59
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Period Lengh is : " + CalculatePeriodLength(p1));
            Console.WriteLine("Period Lengh (Including End Date) is : " + CalculatePeriodLength(p1,true));
